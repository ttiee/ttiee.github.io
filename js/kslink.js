var leonus = {
    linkCom: e => {
        var t = document.querySelector(".vinput.vpreview");
        // window.alert(t.querySelector('p'));
        // t.querySelector('p').innerHTML = '666';
        // t.focus();
        // window.location.reload(t.querySelector('p'))
        // var a = document.createElement('p');
        // a.appendChild(document.createTextNode('6666666'));
        // t.appendChild(a)
